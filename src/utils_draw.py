...
def main():
    def draw_2_box(lst_1, lst_2, name, top_n, save_path, save_check):
        ...
        if p_value < 0.001:
            ...
            logo = "ns"
        plt.text((x_pos[0] + x_pos[1]) / 2, y_pos - y_offset / 2, logo, color='#8B0000', ha='center', va='bottom',
                 fontsize=30)
    ...
    draw_2_box(topK_STPL, ALL_STPL, "Average shortest path length", "Top " + str(K), "avg_shortest_path_length.pdf",
               True)
